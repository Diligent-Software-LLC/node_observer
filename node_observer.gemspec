require_relative './lib/node_observer/version'

Gem::Specification.new do |spec|

  # Required attributes.
  spec.name                  = "node_observer"
  spec.version               = NodeObserverLibrary::VERSION
  spec.authors               = ["Diligent Software LLC"]
  spec.email                 = ["contact@diligentsoftware.org"]
  spec.summary               = %q{A NodeObserver library.}
  spec.description           = %q{A NodeObserver library. Donations support
...
are available at $1, $2, $4, $8, and $16. Greatly appreciated.}
  spec.homepage              = "https://docs.diligentsoftware.org/observer#node"
  ...
  spec.metadata['source_code_uri'] =
      "https://github.com/Diligent-Software-LLC/node_observer"
